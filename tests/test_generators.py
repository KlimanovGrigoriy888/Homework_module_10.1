...
def test_transaction_descriptions(transactions):
    assertion_result = ['Перевод организации',
    'Перевод со счета на счет',
    'Перевод со счета на счет',
    'Перевод с карты на карту',
    'Перевод организации']
    assert list(transaction_descriptions(transactions)) == assertion_result


def test_transaction_descriptions_wrong(transactions_wrong_description):
    assertion_result = ['Перевод организации',
 'hhh',
 666,
 'Перевод с карты на карту',
...
def test_card_number_generator_end_range():
    assertion_result = ['9999 9999 9999 9995',
'9999 9999 9999 9996',
'9999 9999 9999 9997',
'9999 9999 9999 9998',
'9999 9999 9999 9999']
    assert list(card_number_generator(9999999999999995, 10000000000000000)) == assertion_result


def test_card_number_generator_start_range():
    assertion_result = ['0000 0000 0000 0001',
 '0000 0000 0000 0002',
 '0000 0000 0000 0003',
 '0000 0000 0000 0004',
 '0000 0000 0000 0005']
    assert list(card_number_generator(0, 5)) == assertion_result