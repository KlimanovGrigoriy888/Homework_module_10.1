...
def filter_by_currency(data_array_transactions: list[dict], filter_currency: str) -> Iterable[dict[Any, Any]]:
    ...
    if not data_array_transactions or not filter_currency:
        raise ValueError
